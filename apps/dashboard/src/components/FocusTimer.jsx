...
export default function FocusTimer({ onDone }) {
    ...
    const glowColor = isUrgent ? "rgba(239,68,68,.22)" : isWarning ? "rgba(245,158,11,.18)" : "rgba(17,18,24,.12)";
    ...
    return (
        <div className="ft-card" style={{
                ...
                <div style={{ position: "relative", flexShrink: 0 }}>
                    ...
                    <svg width={SIZE} height={SIZE} style={{ display: "block", transform: "rotate(-90deg)" }}>
                        ...
                        <circle
                            ...
                            style={{ transition: "stroke-dashoffset .9s linear, stroke .4s", filter: `drop-shadow(0 0 6px ${accent}55)` }}
                        />
                    </svg>
                    ...
                    <div style={{
                        ...
                        <span style={{
                            ...
                            {isUrgent ? "⚡ Urgent" : isWarning ? "Almost done" : running ? "Focusing" : "Ready"}
                        </span>
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
                            ...
                            <span style={{
                                ...
                                boxShadow: running ? "0 0 7px #22C55E" : "none",
                            ...
                            {[["H", h, setH, 23], ["M", m, setM, 59], ["S", s, setS, 59]].map(([lbl, val, setter, max], i) => (
                                <div key={lbl} style={{ display: "flex", alignItems: "center", gap: 3 }}>
                                    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 1 }}>
                                        <span style={{ fontSize: 8, fontWeight: 700, color: "#B0B7C3", letterSpacing: ".1em", fontFamily: "'Poppins',sans-serif", textTransform: "uppercase" }}>{lbl}</span>
                                        <input
                                    ...
                                    {i < 2 && (
                                        <span style={{ fontSize: 15, fontWeight: 800, color: "#D1D5DB", lineHeight: 1, marginTop: 10 }}>:</span>
                                    )}
                                </div>
                            ))}
                        </div>
            ...
            <style>{`
                ...
                .ft-card:hover {
                    box-shadow: 0 1px 3px rgba(0,0,0,.04), 0 12px 40px rgba(0,0,0,.09) !important;
                }
                ...
                @media (max-width: 680px) {
                    .ft-inner { flex-direction: column !important; padding: 18px 20px !important; gap: 20px !important; }
                }
            `}</style>
        </div>
    );
